            ...
            if (action.equals(WifiManager.WIFI_STATE_CHANGED_ACTION)) {
                ...
                switch (state) {
                    case WifiManager.WIFI_STATE_ENABLED:
                        Toast.makeText(context, R.string.info_wifi_enabled, Toast.LENGTH_SHORT).show();
                    ...
                    case WifiManager.WIFI_STATE_DISABLED:
                        Toast.makeText(context, R.string.info_no_wifi, Toast.LENGTH_SHORT).show();
                        mDeviceListAdapter.clear();
                        mItemListAdapter.clear();
                        break;
                    case WifiManager.WIFI_STATE_UNKNOWN:
                        Toast.makeText(context, R.string.unknown_wifi_state, Toast.LENGTH_SHORT).show();
                        break;
                }
            }
        }
